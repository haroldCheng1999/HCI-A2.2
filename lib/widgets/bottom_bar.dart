    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            IconButton(
              splashColor: const Color.fromARGB(0, 12, 11, 11),
              highlightColor: const Color.fromARGB(0, 18, 17, 17),
            ...
            IconButton(
              splashColor: const Color.fromARGB(0, 13, 13, 13),
              highlightColor: const Color.fromARGB(0, 13, 13, 13),
              enableFeedback: false,
              onPressed: () {
                setState(() {
                  _selectedIndex = 1;
